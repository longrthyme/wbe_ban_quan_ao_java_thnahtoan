...
<body>
   ...
   <div class="modal-body">
    ...
    <form action="/san-pham/detail/${id}" method="get">
     ...
     <form id="main" action="/san-pham/update/detail/${sanPhamCT.id_san_pham_ct}" method="post">
         <!-- Hidden field to send the ID -->
         <h1>Cập nhật sản phẩm </h1>
         <input type="hidden" name="id" value="${sanPhamCT.id_san_pham_ct}">
         ...
         <div class="mb-3" hidden>
             ...
             <input type="text" id="id_san_pham_ct" name="id_san_pham_ct" value="${sanPhamCT.sanPham.id}" class="form-control" required>
         </div>
             ...
             <label for="idMauSac">Màu Sắc</label>
                 ...
                 <c:forEach var="mauSac" items="${mauSacs}">
                     <option value="${mauSac.idMS}"
                             ${mauSac.idMS == sanPhamCT.mauSac.idMS ? 'selected' : ''}>
                         ${mauSac.tenMS}
                     </option>
                 </c:forEach>
             </select>
        ...
        <select id="idThuongHieu" name="idThuongHieu" class="form-control" required>
         ...
         <div class="mb-3">
             ...
             <input type="text" id="size" name="size" value="${sanPhamCT.size}" class="form-control" required>
         </div>

         <div class="mb-3">
             <label for="gia">Giá</label>
             <input type="text" id="gia_ban" name="gia_ban" value="${sanPhamCT.gia_ban}" class="form-control" required>
         </div>

         <div class="mb-3">
             <label for="soLuongTon">Số Lượng Tồn</label>
             <input type="number" id="so_luong_ton" name="so_luong_ton" value="${sanPhamCT.so_luong_ton}" class="form-control" required>
         </div>

         <div class="mb-3" hidden>
             <label for="trangThai">Trạng Thái</label>
             <input type="checkbox" id="trangThai" name="trangThai" ${sanPhamCT.trang_thai == 1 ? 'checked' : ''}>
         </div>
