...
<div class="btn-doanh-thu">
    <form action="/thong-ke/thong-ke">
        <button type="submit">Năm hiện tại</button>
    </form>
    <form action="/thong-ke/thang-nay" method="get">
        <input type="hidden" id="currentMonth" name="month">
        <button type="submit" class="btn btn-secondary" disabled>Tháng hiện tại</button> <!-- Nút này sẽ bị mờ và không thể ấn được -->
    </form>
    <form action="/thong-ke/hom-nay" method="get">
...
<div class="container">
    <h2 style="text-align: center;">Biểu đồ thống kê doanh thu tháng ${month}</h2>
...
<script th:inline="javascript">
    document.addEventListener("DOMContentLoaded", function () {
        // Lấy danh sách ngày từ backend
        var days = ${days}; // Thymeleaf sẽ thay thế thành danh sách các ngày từ 1 đến số ngày trong tháng

        // Truyền dữ liệu tổng tiền tương ứng với từng ngày từ backend
        var data = ${totalAmounts}; // Mảng dữ liệu tổng tiền theo ngày, truyền từ backend

        // Kiểm tra dữ liệu được truyền
        console.log("Danh sách ngày:", days);
        console.log("Dữ liệu tổng tiền:", data);
        ...
        var myChart = new Chart(ctx, {
            type: 'bar',
            data: {
                labels: days, // Dùng danh sách ngày làm nhãn cho trục X
                datasets: [{
                    label: 'Tổng tiền theo ngày',
                    data: data, // Dữ liệu tổng tiền tương ứng với từng ngày
