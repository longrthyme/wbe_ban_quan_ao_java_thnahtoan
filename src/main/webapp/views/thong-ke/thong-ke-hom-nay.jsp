...
<div class="btn-doanh-thu">
    ...
    <form action="/thong-ke/thang-nay" method="get">
        ...
        <button type="submit">Tháng hiện tại</button> <!-- Nút này sẽ bị mờ và không thể ấn được -->
    </form>
    <form action="/thong-ke/hom-nay" method="get">
        <input type="hidden" id="today" name="today">
        <button type="submit" class="btn btn-secondary" disabled>Hôm nay</button>
    </form>
</div>
<br>
<br>
...
<body>
<div class="container">
    <h2 style="text-align: center;">Biểu đồ thống kê doanh thu ${today}</h2>
...
<script th:inline="javascript">
    ...
    document.addEventListener("DOMContentLoaded", function() {
        // Lấy ngày hôm nay và tổng tiền hôm nay từ model
        var today = [[${today}]];  // Ngày hôm nay (10-01-2025 chẳng hạn)
        var todayMoney = [[${todayMoney}]];  // Tổng tiền hôm nay

        // Kiểm tra dữ liệu từ backend
        console.log("Ngày hôm nay:", today);
        console.log("Tổng tiền hôm nay:", todayMoney);
        ...
        var myChart = new Chart(ctx, {
            ...
            data: {
                labels: [today], // Trục X là ngày hôm nay
                datasets: [{
                    label: 'Tổng tiền hôm nay',
                    data: [todayMoney], // Trục Y là tổng tiền
