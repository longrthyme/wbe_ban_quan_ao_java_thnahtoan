...
<div class="checkout-container">
    ...
    <form action="/trang-chu/add-mua-ngay" method="POST">
    ...
    <!-- Địa chỉ nhận hàng -->
        <input type="hidden" name="idSanPhamChiTiet" value="${param.idSanPhamChiTiet}">
...
<%--    </div>--%>
    ...
    <div class="summary-section" style="display: none;">
        ...
        <div class="summary-details">
            ...
            <span id="total-price">${sanPhamChiTiet.gia_ban}₫</span>
        </div>
...
<script>
    ...
    function updateTotalPrice() {
        ...
        // Lấy giá trị của phần tử có id="shippingFee"
        let shippingFeeText = document.getElementById("shippingFee").innerText;

        // Loại bỏ các ký tự không phải số (ví dụ: "₫" và dấu phẩy nếu có)
        let shippingFee = parseInt(shippingFeeText.replace(/[^\d]/g, ''));
        ...
        // Tính tổng tiền
        const total = price * quantity;
        const totalAll = total + shippingFee;
        ...
        document.getElementById('total-pay-price').textContent = formatCurrency(totalAll);
    }
