    ...
    <div class="cart-container">
        <p class="cart-title">Tổng sản phẩm: 1</p>
            ...
            <table class="cart-table">
                ...
                <tbody>
                <c:forEach items="${gioHangs}" var="gh">
                    <tr>
                        ...
                        <td>
                            <form action="/trang-chu/bo-chon" method="POST">
                                <input type="hidden" name="idGioHang" value="${gh.id_gio_hang}">
            ...
            <div class="cart-footer">
                ...
                <div class="payment-summary">
                    <p class="total-label">Tổng thanh toán: <span class="total-payment">${totalPayment}</span></p>

                    <form action="/trang-chu/thanh-toan-gio-hang" method="GET">
                        <c:forEach items="${gioHangs}" var="gh">
                            <input type="hidden" name="idGioHang" value="${gh.id_gio_hang}"/>
                        </c:forEach>
...
// Hàm để chọn hoặc bỏ chọn tất cả checkbox dựa trên giá trị combobox
    function toggleSelectAll(selectElement) {
        ...
        } else if (selectElement.value === 'deselect-all') {
            checkboxes.forEach(function(checkbox) {
                checkbox.checked = false; // Bỏ chọn tất cả
            });
        }
    }
